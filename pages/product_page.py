...
class ProductPage(BasePage):
    def add_product_to_basket(self):
        ...
        #есть ли сообщение о добавлении (перенесла в тест)
        #self.should_be_success_message()
        #название совпадает с добавленным (перенесла в тест)
        #self.should_be_the_right_name()
        #есть ли сообщение со стоимостью корзины (перенесла в тест)
        #self.should_be_sum_message() 
        #стоимость совпадает с ценой (перенесла в тест)
